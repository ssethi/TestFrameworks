namespace Caliburn.PresentationFramework.RoutedMessaging
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLog(typeof(DefaultMessageBinder));

        private readonly IConventionManager conventionManager;
        private readonly IDictionary<string, Func<IInteractionNode, object, object>> valueHandlers;
        ...
        public virtual IResult CreateResult(MessageProcessingOutcome outcome)
        {
            ...
            return outcome.Result as IResult ?? new DefaultResult(conventionManager, outcome);
        }
