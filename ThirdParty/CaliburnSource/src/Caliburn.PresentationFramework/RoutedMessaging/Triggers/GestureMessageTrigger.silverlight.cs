...
namespace Caliburn.PresentationFramework.RoutedMessaging.Triggers
{
    ...
    {
        /// <summary>
        /// The interval used in detecting double clicks.
        /// </summary>
        public static TimeSpan DoubleClickInterval = TimeSpan.FromMilliseconds(200);
        ...
        private void element_LeftClick(object sender, MouseButtonEventArgs e)
        {
        ...
        private void element_LeftDoubleClick(object sender, MouseButtonEventArgs e)
        {
            var difference = DateTime.Now - _lastClick;
        ...
        private void element_RightDoubleClick(object sender, MouseButtonEventArgs e)
        {
            var difference = DateTime.Now - _lastClick;
